...
G2=guard(500/par,700/par)
G3=guard(16000/par,700/par)
G4=guard(27000/par,700/par)
G5=guard(8000/par,700/par)
...
for i in range(int(xmax)):
    for j in range(int(ymax)):
        ...
        vis5=visiblecheck(i,j,G5.x,G5.y,G5.theta11,G5.theta13,G5.theta21,G5.theta23,G5.theta31,G5.theta33,G5.r11,G5.r13,G5.r21,G5.r23,G5.r31,G5.r33)
        
        if (vis1+vis2+vis3+vis4+vis5)>=1:
...
pg.draw.circle(scr,black,(int(G5.x/xmax*xmaxscr),int(G5.y/ymax*ymaxscr)),int(3000/xmaxscr))
