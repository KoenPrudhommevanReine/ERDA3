...
#guards
G1=guard(10/par,10/par)
G2=guard(5000/par,5000/par)
G3=guard(30000/par,3000/par)
G4=guard(1000/par,1000/par)
...
for i in range(int(xmax)):
    for j in range(int(ymax)):
        ...
        scr.set_at((int(i/xmax*xmaxscr),int(ymaxscr-(j/ymax*ymaxscr))),red)
        b=b+1
        ...
        if (vis1+vis2+vis3+vis4)>=1:
            scr.set_at((int(i/xmax*xmaxscr),int(ymaxscr-(j/ymax*ymaxscr))),green)
            c=c+1
...
pg.draw.line(scr,black,(int(point11.x/xmax*xmaxscr),int(ymaxscr-(point11.y/ymax*ymaxscr))),(int(point13.x/xmax*xmaxscr),int(ymaxscr-(point13.y/ymax*ymaxscr))))
pg.draw.line(scr,black,(int(point21.x/xmax*xmaxscr),int(ymaxscr-(point21.y/ymax*ymaxscr))),(int(point23.x/xmax*xmaxscr),int(ymaxscr-(point23.y/ymax*ymaxscr))))
pg.draw.line(scr,black,(int(point31.x/xmax*xmaxscr),int(ymaxscr-(point31.y/ymax*ymaxscr))),(int(point33.x/xmax*xmaxscr),int(ymaxscr-(point33.y/ymax*ymaxscr))))
pg.draw.circle(scr,black,(int(G1.x/xmax*xmaxscr),int(ymaxscr-(G1.y/ymax*ymaxscr))),int(3000/xmaxscr))
pg.draw.circle(scr,black,(int(G2.x/xmax*xmaxscr),int(ymaxscr-(G2.y/ymax*ymaxscr))),int(3000/xmaxscr))
pg.draw.circle(scr,black,(int(G3.x/xmax*xmaxscr),int(ymaxscr-(G3.y/ymax*ymaxscr))),int(3000/xmaxscr))
pg.draw.circle(scr,black,(int(G4.x/xmax*xmaxscr),int(ymaxscr-(G4.y/ymax*ymaxscr))),int(3000/xmaxscr))
